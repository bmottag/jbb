				...
				<div class="panel-heading">
					...
					<div class="pull-right">
						<div class="btn-group">
							...
							<a href="<?php echo base_url("reportes/comparendos/". $info[0]['id_equipo']); ?>" class="btn btn-primary btn-xs" target="_blank"><span class="fa fa-file-pdf-o" aria-hidden="true"></span> Descargar Formato - FIS.PR.06.F.12 </a>
						</div>
					</div>
				</div>
